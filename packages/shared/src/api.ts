...
export const API = {
  ...
  companyHeartbeatRuns: `${API_PREFIX}/companies/:companyId/heartbeat-runs`,
  companyLiveRuns: `${API_PREFIX}/companies/:companyId/live-runs`,
  companyBuiltInAgents: `${API_PREFIX}/companies/:companyId/built-in-agents`,
  heartbeatRun: `${API_PREFIX}/heartbeat-runs/:runId`,
  heartbeatRunEvents: `${API_PREFIX}/heartbeat-runs/:runId/events`,
  heartbeatRunLog: `${API_PREFIX}/heartbeat-runs/:runId/log`,
  heartbeatRunWorkspaceOperations: `${API_PREFIX}/heartbeat-runs/:runId/workspace-operations`,
