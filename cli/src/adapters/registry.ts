...
import { printOpenCodeStreamEvent as printOpenCode9RouterStreamEvent } from "@paperclipai/adapter-opencode-9router/cli";
...
const openCode9RouterCLIAdapter: CLIAdapterModule = {
  type: "opencode_9router",
  formatStdoutEvent: printOpenCode9RouterStreamEvent,
};
