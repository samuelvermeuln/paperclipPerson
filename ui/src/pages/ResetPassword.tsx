    ...
    <div className="fixed inset-0 flex items-center justify-center bg-background px-4">
      <div className="w-full max-w-md space-y-4 rounded-lg border border-border bg-card p-6">
        <div>
          ...
          <p className="text-sm text-muted-foreground">Informe e-mail, código e nova senha.</p>
        </div>
        <div className="space-y-3">
          <div>
            <label htmlFor="reset-email" className="mb-1 block text-xs text-muted-foreground">E-mail</label>
          ...
          <div>
            <label htmlFor="reset-code" className="mb-1 block text-xs text-muted-foreground">Código</label>
          ...
          <div>
            <label htmlFor="reset-password" className="mb-1 block text-xs text-muted-foreground">Nova senha</label>
          ...
          <div>
            <label htmlFor="reset-confirm-password" className="mb-1 block text-xs text-muted-foreground">Confirmar senha</label>
        ...
        {success ? <p className="text-xs text-emerald-600">Senha redefinida com sucesso.</p> : null}
        <div className="flex gap-3">
          <Button type="button" variant="outline" className="flex-1" onClick={() => navigate("/auth", { replace: true })}>Voltar</Button>
          <Button
            type="button"
            className="flex-1"
